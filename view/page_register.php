...
<h2 class="text-center">
	Cadastro de Clientes <i class="fa fa-user-plus"></i>
</h2><hr>
...
<div class="container">
	<div class="form-row">
		...
		<div class="col-md-12">
			...
			<input class="form-control" type="address" name="address" required><br>
		</div>
		...
		<div class="col-md-4">
			...
			<button class="btn btn-primary btn-lg">
				...
				Adicionar Cliente <i class="fa fa-user-plus"></i>
